...
public class PatternCheck {
	...
	public void passwordPatternRule2() {
	...
	public void passwordPatternRule3() {
		...
		System.out.println("Enter Password : ");
			...
			while (true) {
				...
				if (Pattern.matches(pattern, password)) {
					...
					System.out.println("The pswd should be minimum Eight letters and atleast one Uppercase,one digit");
				}
			}
		}

	public void passwordPatternRule4() {
		...
		System.out.println("Enter Password : ");
			...
			while (true) {
				...
				if (Pattern.matches(pattern, password)) {
					...
					System.out.println("The pswd should be minimum Eight letters and atleast one Uppercase,one digit and One Specialchar");
				}
			}
		}
}